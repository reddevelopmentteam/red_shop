<div class="flex justify-between items-center px-16 py-6">
    <img src=<?php echo e(asset('images/logo/brand.png')); ?> alt="brand" width="189">
    <div class="flex gap-4 items-center">
            ...
            <div x-data="{
                ...
                <div x-ref="panel" x-show="open" x-transition.origin.top.left x-on:click.outside="close($refs.button)"
                    ...
                    <div class="flex flex-col flex-1 gap-5 min-w-64">
                        <div>
                            <div class="grid grid-cols-3 gap-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <a href="<?php echo e($category['name'] === 'Semua Template' ? '/catalog' : '/catalog?kategori=' . $category['name']); ?>"
                                        class="flex items-center gap-2.5 px-3 py-2 rounded-md transition-colors group hover:bg-[#F87171]/10 min-w-[213.33px]">
                                        <iconify-icon icon="material-symbols:<?php echo e($category['icon']); ?>"
                        ...
                        <div>
                            ...
                            <div class="flex gap-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $featuredTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <a href="<?php echo e(route('product', Str::slug($template['name']))); ?>" wire:navigate class="flex flex-col gap-2 w-50 group shadow-sm rounded-lg h-fit">
                                        <img src="https://picsum.photos/seed/<?php echo e(Str::slug($template['name'])); ?>/600/400"
                                        ...
                                        <div class="p-3">
                                            <span
                                                class="font-family-body text-[16px] text-text-primary"><?php echo e($template['name']); ?></span>
                                            <span
                                                class="font-family-display text-xl font-semibold text-text-primary"><?php echo e($template['price']); ?></span>
                                        </div>
                                    </a>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </div>
                    ...
                    <div
                        ...
                        <img src="<?php echo e(asset('images/catalog/dropsidebar.png')); ?>" alt="Custom template illustration"
                            width="200">
        ...
        <div x-data="{ open: false }" @click.away="open = false" class="relative">
            <form action="/catalog" method="GET" class="shadow-sm rounded-lg flex justify-between items-center px-6 py-2.5 min-w-161 bg-white">
                <input type="search" name="cari" value="<?php echo e(request('cari')); ?>"
...
</div><?php /**PATH /var/www/html/dev/red_shop/storage/framework/views/livewire/views/b90572b4.blade.php ENDPATH**/ ?>