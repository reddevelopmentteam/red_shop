<section class="py-8">
    ...
    @php
        $templates = $this->featuredTemplates();
    @endphp
            ...
            @foreach ($templates as $template)
                ...
                <a href="{{ route('product', Str::slug($template['name'])) }}"
                    ...
                    <div class="relative h-62.5 overflow-hidden">
                        ...
                        <span
                            class="absolute bottom-3 right-3 rounded-full px-4 py-3 font-family-body text-xs font-medium {{ $statusConfig['class'] }}">
                            {{ $statusConfig['label'] }}
                        </span>
                    </div>
                    <div class="p-4">
    ...
    @else
        <div class="py-8 text-text-secondary">Belum ada produk unggulan.</div>
    @endif
</section>
